...
export default {
  ...
  methods:{
    ...
    newsDelete(news){
        ...
        set(fireRef(db, `news/`), this.newsList);
    },
    close(news){
    ...
    getData(news){
      ...
      if(this.imgData !== null && this.imgData !== undefined){
                const storageRef = ref(storage, `news-logo/` + ident + this.imgData.name);
      ...
      if(this.imgDataStorage !== null && this.imgDataStorage !== undefined){
                for(let element in this.imgDataStorage){
                    const storageRef = ref(storage, `news-galary/` + this.imgDataStorage[element].id + this.imgDataStorage[element].name);
      ...
      setTimeout(() => {
                ...
                if(this.imgData !== null && this.imgData !== undefined){
                    getDownloadURL(ref(storage, `news-logo/` + ident + this.imgData.name)).then((url) => {
                        console.log(1);
                ...
                if(this.imgDataStorage !== null  && this.imgDataStorage !== undefined){
                    for(let element in this.imgDataStorage){
                    getDownloadURL(ref(storage, `news-galary/` + this.imgDataStorage[element].id + this.imgDataStorage[element].name)).then((url) => {
