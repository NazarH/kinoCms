...
<div class='wrapper' id='wrapp'>
   ...
   <div class='content'>
       <img :src='cafeBar.cafeBarMainImg'>
       
       <div class='blocks'>
        <div class='content__left'>
           <h2>{{cafeBar.cafeBarName}}</h2>
           <div>
           {{cafeBar.cafeBarDescr.substr(0, 536)}}
           </div>
           <div class='images-blocks'>
           <img :src='cafeBar.cafeBarGalary[0].img'>
           <img :src='cafeBar.cafeBarGalary[1].img'>
           <img :src='cafeBar.cafeBarGalary[2].img'>
           </div>
           <h2>МЕНЮ</h2>
           <table>
               <tr>
               ...
               <tr>
                   <td>Cell 1</td>
                   <td>Cell 2</td>
                   <td><span>Cell 3</span> <div><input type='checkbox' name='three'></div></td>
               </tr>
               <tr>
                   <td>Cell 4</td>
                   <td>Cell 5</td>
                   <td><span>Cell 6</span> <div><input type='checkbox' name='three'></div></td>
               </tr>
               <tr>
                   <td>Cell 7</td>
                   <td>Cell 8</td>
                   <td><span>Cell 9</span> <div><input type='radio' name='nine'></div></td>
               </tr>
               <tr>
                   <td>Cell 10</td>
                   <td>Cell 11</td>
                   <td><span>Cell 12</span> <div><input type='radio' name='nine'></div></td>
               </tr>
           </table>
