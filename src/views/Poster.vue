...
<div class='wrapper' id='wrapp'>
   <div class='header'>
       ...
       <div class='header__main'>
         <div class='container'>
            ...
            <div class='filmList'>
               <a v-for='film in filmTempArray' @click='getData(film)'>{{film.film_name}}</a>
            </div>
   ...
   <div class='content'>
      ...
      <div class='content_films'>
         <div>
         <div class='content_film' v-for='film in films' :key='film.id'>
            <div>
            <span>Сейчас в кино</span>
            <img :src='film.img' @click='getData(film)'>
            <router-link to="/film" @click='getData(film)' class='filmName'>{{film.film_name}}</router-link>
            <button>
               КУПИТЬ
            </button> 
            </div>
