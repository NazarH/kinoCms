...
<div class='wrapper' id='wrapp'>
   ...
   <div class='content'>
      <img src='assets/dist/img/superprice.jpg'>
      <h2>Акции и скидки</h2>
      <div class='contents'>
      <div class='content__left'>
         <div v-for='stock in stocks' :key='stock.id' class='stock'>
         <img :src='stock.newsMainImg'>
         <div class='newsName' @click='getData(stock)'>
         {{stock.newsName}}
         </div>
         <div class='newsDate'>
         {{stock.newsDate}}
...
export default {
   ...
   methods:{
      ...
      getData2(film){
       ...
       getData(stock){
         this.$router.push({name: 'StocksPage', params:{data: JSON.stringify(stock)} });
         console.log(this.$router);
       },
       getUserFirstFunc(){
          if(localStorage.signIn !== ''){
