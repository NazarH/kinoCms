...
<div class='wrapper' id='wrapp'>
   ...
   <div class='content'>
      <div class='content__img'>
         <img src='assets/dist/img/popcorne.jpg'>
      </div>
      <div class='content-cont'>
      <div class='content_left'>
      <h3>Наши кинотеатры</h3>
      <div class='content_left-cinemas'>
          <div v-for='cinema in cinemas' :key='cinema.id' class='cinema-block'>
             <img :src='cinema.logo' @click='getData(cinema)'>
             <h5 @click='getData(cinema)'>{{cinema.cinemaName}}</h5>
          </div>
      </div>
      </div>

      <div class='content_rigth'> 
        <img src='assets/dist/img/scooter.png'>
...
export default {
   ...
   methods:{
      ...
      getData2(film){
       ...
       getData(cinema){
         this.$router.push({name: 'Cinemas-page', params:{data: JSON.stringify(cinema)} });
         console.log(this.$router);
       },
       getUserFirstFunc(){
           if(localStorage.signIn !== ''){
...
/* ---------------- 0 */
   ...
   .content_rigth>img:first-child{
       margin-top: 114px;
   }

   .content_rigth>img:last-child{
       margin-top: 50px;
   }
