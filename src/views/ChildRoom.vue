...
<div class='wrapper' id='wrapp'>
   ...
   <div class='content'>
       <img :src='childRoom.childRoomMainImg'>
       
       <div class='blocks'>
        <div class='content__left'>
           <h2>{{childRoom.childRoomName}}</h2>
           <div>
           {{childRoom.childRoomDescr}}
           </div>
           <div class='images-blocks'>
           <img :src='childRoom.childRoomGalary[0].img'>
           <img :src='childRoom.childRoomGalary[1].img'>
           <img :src='childRoom.childRoomGalary[2].img'>
           </div>
           <div>
           {{childRoom.childRoomDescr.substr(0, 1016)}}
           </div>
           <h2>ФОТОГАЛЕРЕЯ</h2>
   ...
   methods:{
      ...
      searchFilm(){
       ...
       swipeLeft(){
           this.counter3--;
           if(this.counter3 < 0){
               this.counter3 = this.childRoom.childRoomGalary.length - 1;
           }
           document.getElementById('filmSwiper').src=`${this.childRoom.childRoomGalary[this.counter3].img}`;
       },
       swipeRight(){
           this.counter3++;
           if(this.counter3 > this.childRoom.childRoomGalary.length - 1){
               this.counter3 = 0;
           }
           document.getElementById('filmSwiper').src=`${this.childRoom.childRoomGalary[this.counter3].img}`;
       },
