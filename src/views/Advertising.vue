...
<div class='wrapper' id='wrapp'>
   ...
   <div class='content'>
       <img :src='pageAdv.pageAdvMainImg'>
       
       <div class='blocks'>
        <div class='content__left'>
           <h2>{{pageAdv.pageAdvName}}</h2>
           <div>
           {{pageAdv.pageAdvDescr}}
           </div>
           <div class='images-blocks'>
           <img :src='pageAdv.pageAdvGalary[0].img'>
           <img :src='pageAdv.pageAdvGalary[1].img'>
           <img :src='pageAdv.pageAdvGalary[2].img'>
           </div>
           <div>
           {{pageAdv.pageAdvDescr.substr(0, 1016)}}
           </div>
           <h2>ФОТОГАЛЕРЕЯ</h2>
   ...
   methods:{
      ...
      searchFilm(){
       ...
       swipeLeft(){
           this.counter3--;
           if(this.counter3 < 0){
               this.counter3 = this.pageAdv.pageAdvGalary.length - 1;
           }
           document.getElementById('filmSwiper').src=`${this.pageAdv.pageAdvGalary[this.counter3].img}`;
       },
       swipeRight(){
           this.counter3++;
           if(this.counter3 > this.pageAdv.pageAdvGalary.length - 1){
               this.counter3 = 0;
           }
           document.getElementById('filmSwiper').src=`${this.pageAdv.pageAdvGalary[this.counter3].img}`;
       },
