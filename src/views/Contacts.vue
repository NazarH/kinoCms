...
<div class='wrapper' id='wrapp'>
   ...
   <div class='content'>
       <img src='assets/dist/img/main-cinema.png'>
       
       <div class='blocks'>
        <div class='content__left'>
           <h2>Контакты</h2>
           <div v-for='cont in pageCont.pageContactSinemas' :key='cont.id' class='cinemInf'>
              <div class='left'>
                 <div class='left_first'>
                 <h3>{{cont.pageContactName}}</h3>
                 <img :src='cont.pageContactMainImg' class='mainImg'>
                 </div>
                 <img src='assets/dist/img/main-cinema-1.png'>
              </div>
              <div class='right'>
                 <div>
                 {{cont.pageContactDescr.substr(0, 180)}}
                 </div>
                 <img src='assets/dist/img/main-cinema-2.png'>
              </div>
           </div>
