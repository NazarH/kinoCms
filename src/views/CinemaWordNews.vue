...
<div class='wrapper' id='wrapp'>
   ...
   <div class='content'>
      <img src='assets/dist/img/supernews.jpg'>
      <h2>Новости</h2>
      <div class='contents'>
      <div class='content__left'>
         <div v-for='news in newsData' :key='news.id' class='stock'>
         <img :src='news.newsMainImg'>
         <div class='newsName' @click='getData(news)'>
         {{news.newsName}}
         </div>
         <div class='newsDate'>
         {{news.newsDate}}
         ...
         <div class='newsDescr'>
         {{news.newsDescr.substr(0, 198)}}.
         </div>
         </div>
      </div>
      <div class='content__right'>
      <img src='assets/dist/img/book_banner.PNG'>
      <img src='assets/dist/img/stock-vk.png'>
      </div>
      </div>
...
export default {
   ...
   methods:{
      ...
      getData2(film){
       ...
       getData(news){
         this.$router.push({name: 'NewsPage', params:{data: JSON.stringify(news)} });
         console.log(this.$router);
       },
       getUserFirstFunc(){
          if(localStorage.signIn !== ''){
